...
urlpatterns = [
    ...
    path('create/', TemplateView.as_view(template_name='product/create.html'),
         name='product-create'),
    ...
    # Usa uma Template Genérica para uma página estática
    path('create/', TemplateView.as_view(template_name='products/create.html'),
         name='product-create'),

    path('categories/<int:id_category>/delete',
         views.CategoryDeleteView.as_view(), name='category-delete'),

    # Recupera um categoria específico (GET), atualiza (PUT/PATCH)
    path('categories/<int:id_category>/',
