...
class AuditService:
    ...
    @staticmethod
    def log_action(
        user, action, obj=None, old_values=None, new_values=None, request=None, **extra
    ):
        """
    ...
    def log_login(user, request=None, **extra):
        """Registra um login"""
        return AuditService.log_action(
            user=user, action="login", request=request, **extra
        )
    ...
    def log_logout(user, request=None, **extra):
        """Registra um logout"""
        return AuditService.log_action(
            user=user, action="logout", request=request, **extra
        )
    ...
    def log_view(user, obj, request=None, **extra):
        ...
        return AuditService.log_action(
            user=user, action="view", obj=obj, request=request, **extra
        )
    ...
    def log_approve(user, obj, request=None, **extra):
        ...
        return AuditService.log_action(
            user=user, action="approve", obj=obj, request=request, **extra
        )
    ...
    def log_reject(user, obj, request=None, **extra):
        ...
        return AuditService.log_action(
            user=user, action="reject", obj=obj, request=request, **extra
        )
